...
document.getElementById('anneePromotion').addEventListener('change', function()
{
    ...
    // Vide tous les champs d'affichage
    ...
    document.getElementById('nbAvisPromo').textContent = '0'; // Remet à zéro
    ...
    if (annee)
    {
        fetch('/api/etudiants/' + annee)
            ...
            .then(data =>
            {
                ...
                // Mets à jour le nombre d'avis pour la promo
...
document.getElementById('nomEtudiant').addEventListener('change', function()
{
    ...
    // Affiche parcours BUT et mobilité
    ...
    // Récupère et affiche les apprentissages
    if (id) {
